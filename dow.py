...
def holap(app, message):
    app.send_message(message.chat.id,"Bienvenido al bot de descargas:\n*Actualmente solo soporta:\n>YouTube.\n\nModo de uso: /descargar (y la url)\n*Puede cambiar la calidad de descarga en /calidad\nSi el archivo excede los 2GB sera imposible enviarlo, en ese caso intente descargarlo con una calidad menor")
